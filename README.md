# 2026年09月26日04时47分 免费节点订阅说明

本目录中的配置整理自公开节点页面。

文件已于 2026年09月26日04时47分 下载、合并和校验。它们是当天的静态快照，不会自动更新。
...
节点已于 2026-09-26 12:47 CST 通过对应代理内核实际访问 `https://cp.cloudflare.com/generate_204`。只有至少一次测试成功的节点才会进入发布文件；测试失败、超时、格式不受支持及指向非公网地址的节点均已移除。

- Clash：原始 3401，可测试 3396，通过 2405
- V2Ray：原始 3862，可转换测试 3715，通过 2729
- Sing-box：原始 9，可测试 8，通过 3
