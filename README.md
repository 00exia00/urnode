# 2026年09月16日04时41分 免费节点订阅说明

本目录中的配置整理自公开节点页面。

文件已于 2026年09月16日04时41分 下载、合并和校验。它们是当天的静态快照，不会自动更新。
...
节点已于 2026-09-16 12:41 CST 通过对应代理内核实际访问 `https://cp.cloudflare.com/generate_204`。只有至少一次测试成功的节点才会进入发布文件；测试失败、超时、格式不受支持及指向非公网地址的节点均已移除。

- Clash：原始 499，可测试 496，通过 25
- V2Ray：原始 2085，可转换测试 1997，通过 485
- Sing-box：原始 22，可测试 19，通过 9
