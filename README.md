# 2026年09月14日04时45分 免费节点订阅说明

本目录中的配置整理自公开节点页面。

文件已于 2026年09月14日04时45分 下载、合并和校验。它们是当天的静态快照，不会自动更新。
...
节点已于 2026-09-14 12:45 CST 通过对应代理内核实际访问 `https://cp.cloudflare.com/generate_204`。只有至少一次测试成功的节点才会进入发布文件；测试失败、超时、格式不受支持及指向非公网地址的节点均已移除。

- Clash：原始 4021，可测试 4018，通过 2852
- V2Ray：原始 6060，可转换测试 5858，通过 3369
- Sing-box：原始 20，可测试 19，通过 11
